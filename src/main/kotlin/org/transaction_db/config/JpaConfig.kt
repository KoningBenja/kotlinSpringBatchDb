...
import org.transaction_db.common.constant.DataSourceConstants.SERVICE_ENTITY_MANAGER
...
@EnableJpaRepositories(
    basePackages = ["org.transaction_db.domain.repository"],
...
class JpaConfig(
    ...
    fun serviceEntityManager(
        ...
        return LocalContainerEntityManagerFactoryBean().apply {
            ...
            this.setPackagesToScan("org.transaction_db.domain.entity")
        }
    }
